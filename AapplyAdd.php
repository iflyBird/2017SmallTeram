...
<div id="outer"  align="center">
    <form action="AapplyAddAction.php" method="post">
        ...
        <table style="width:302px;">
            ...
            <tr>
                <td colspan="2" >
        <input id="btn" type="button" value="返回" onclick="window.location.href='AapplyList1.php'"><input id="btn" type="submit" value="添加" >
                </td>
            </tr>
