...
//.$pageCount=ceil($rowCount/$pageSize）,既然$rowCount可以初始值为0，那么$pageCount当然也就可以设置为0.四个指标，两个0 ，一个1，另一个为网站需求。]
    ...
    //4.12计算共有多少页
     ...
     echo"<form action='AconSelectAction1.php' method='post'>";
     ...
     echo"<br/>";
     echo"<hr/>";
     echo "<tr><th>编号</th><th>申请编号</th><th>成绩</th><th>名次</th><th>备注</th><th>操作1</th><th>操作2</th><th>操作3</th></tr>";
    ...
    echo "</tr>";
     ...
     echo"</td>";
     echo "</tr>";
     echo "<tr><td colspan='13'><a href='AconAdd.php' ><b><font size='5' >添加</font></b></a></td></tr>";
     echo "</table>";
     //4.14打印出页码的超链接
     ...
     echo"&nbsp;&nbsp;&nbsp;&nbsp;";
     echo"<a href='Administrator.php' ><b><font size='5' >返回</font></b></a>";
?>
</html> 