...
<body background="img/pb14.jpg">
<div id="outer" style="text-align: center;" class="obj  box-shadow">
    <form action="AstuAddAction.php" method="post">
        <p id="xinzeng">新增学生</p>
        <table style="width:302px;">
           ...
           <td >
                <select name="stuSex" style="width: 150px;">    
			...
			<option  value="31">31</option>
              ...
              <tr>
                ...
                <td><input type="text" name="stuYX" ></td>
            </tr>
           
            
              <tr>
                <td align='right'>&nbsp;&nbsp;&nbsp;&nbsp;学生专业：</td>
                <td><input type="text" name="stuPro" ></td>
            </tr>
            <tr>
                <td align='right'>&nbsp;&nbsp;&nbsp;&nbsp;学生学院：</td>
                <td><input type="text" name="stuXueYuan" ></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" >
        <input id="btn" type="button" value="返回" onclick="window.location.href='AstuList1.php'"><input id="btn" type="submit" value="添加" >
                </td>
            </tr>
