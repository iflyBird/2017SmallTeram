...
<body background="img/pb17.jpg"></body>
<?php 
      //  session_start();
...
//.$pageCount=ceil($rowCount/$pageSize）,既然$rowCount可以初始值为0，那么$pageCount当然也就可以设置为0.四个指标，两个0 ，一个1，另一个为网站需求。]
    ...
    //4.12计算共有多少页
     ...
     echo"<form action='AteamSelectAction1.php' method='post'>";
    ...
    echo "</tr>";
     ...
     echo"</td>";
     echo "</tr>";
     echo "<tr><td colspan='13'><a href='AteamAdd.php' ><b><font size='5' >添加</font></b></a></td></tr>";
     echo "</table>";
     //4.14打印出页码的超链接
