...
//.$pageCount=ceil($rowCount/$pageSize）,既然$rowCount可以初始值为0，那么$pageCount当然也就可以设置为0.四个指标，两个0 ，一个1，另一个为网站需求。]
    ...
    //4.12计算共有多少页
     ...
     echo"<form action='SteaSelectAction2.php' method='post'>";
     ...
     echo"<br/>";
     echo"<hr/>";
     echo "<tr><th>教师编号</th><th>教师姓名</th><th>教师性别</th><th>教师电话</th><th>教师邮箱</th><th>教师专业</th><th>教师职务</th><th>教师学院</th><th>教师密码</th><th>教师备注</th></tr>";
