...
<?php 
    ...
    $sql="select teaID,teaName,teaSex,teaTel,teaYX,teaPro,teaXueYuan,teaPost,teaPS,teaPwd from teacherinfor  where  teaID='$teaID' OR teaName='$teaName'";
     ...
     echo "<tr><th>教师编号</th><th>教师姓名</th><th>教师性别</th><th>教师电话</th><th>教师邮箱</th><th>教师专业</th><th>教师学院</th><th>教师职务</th><th>教师备注</th><th>教师密码</th></tr>";
    ...
    echo "</tr>";
     ...
     echo"</td>";
     echo "</tr>";
     echo "<tr><td colspan='13'><a href='SteaList2.php' ><b><font size='5' >返回</font></b></a></td></tr>";
     echo "</table>";
