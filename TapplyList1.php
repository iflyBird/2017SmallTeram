...
//.$pageCount=ceil($rowCount/$pageSize）,既然$rowCount可以初始值为0，那么$pageCount当然也就可以设置为0.四个指标，两个0 ，一个1，另一个为网站需求。]
     ...
     $sql="select count(appID) from enlistresult";
    ...
    //4.12计算共有多少页
     ...
     //4.13发送带有分页的sql结果
     //SELECT comName,teamName,teaName from team,contestinfor,teacherinfor,enlistresult
    // where  team.teamID=enlistresult.teamID
    // and contestinfor.comID=enlistresult.comID
     //and teacherinfor.teaID=enlistresult.teaID
     //$sql="SELECT appID,comName,teamName,teaName,elseInfor,state from team,contestinfor,teacherinfor,enlistresult
     //   where  team.teamID=enlistresult.teamID
      //  and contestinfor.comID=enlistresult.comID
       // and teacherinfor.teaID=enlistresult.teaID limit $pageStart,$pageSize";//[根据$sql语句的limit 后面的两个值（起始值，每页条数），来实现分页。以及求得这两个值。]
     $sql="select * from enlistresult limit $pageStart,$pageSize";
     $res2=mysql_query($sql,$conn) or die('无法获取结果集'.mysql_error());
     //echo '<table border=1>';  
     echo "<caption><font size='8' color='blue'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;查看申请信息</font></caption>";
     echo"<form action='TapplySelectAction1.php' method='post'>";
     echo "<table border='1' cellspacing='0' width='1000' align='center'>";
     echo"<br/>";
     echo"<hr/>";
     echo " &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a><font size='5' >申请编号：</font></a><input type='text' name='appID' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; />";
     echo " &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a><font size='5' >团队编号：</font></a><input type='text' name='teamID' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; />";
    ...
    echo "<td align='center'><a href ='TapplyCheck.php?appID=$emp[appID]'><b><font size='5' color='#FF00FF'>审核</font></b></a></td>";
    echo "<td align='center'><a href ='TapplyModify.php?appID=$emp[appID]'><b><font size='5' color='#FF00FF'>修改</font></b></a></td>";
    echo "<td align='center'><a href ='TapplyDeleteAction.php?appID=$emp[appID]'><b><font size='5' color='red'>删除</font></b></a></td>";
    echo "</tr>";
     }
     ...
     echo"</td>";
     echo "</tr>";
     echo "<tr><td colspan='13'><a href='TapplyAdd.php' ><b><font size='5' >添加</font></b></a></td></tr>";
     echo "</table>";
     //4.14打印出页码的超链接
     ...
     echo "&nbsp;&nbsp;&nbsp;";
     echo"<a href='TeacherPage.php' ><b><font size='5' >返回老师</font></b></a>";
?>
</body>
</html> 